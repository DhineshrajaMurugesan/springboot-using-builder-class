...
public class EmployeeControllerIT {
   ...
   public void getAll() {
    ...
    public void getOneItemsById() {
        when().get(EVENT_RESOURCE4, firstEvent.getEmployeeId()).then().statusCode(HttpStatus.SC_OK);
    }

    @Test
    // DELETE
    public void deleteById() {
        when().delete(EVENT_RESOURCE5, secondEvent.getEmployeeId()).then().statusCode(HttpStatus.SC_OK);
    }
} 